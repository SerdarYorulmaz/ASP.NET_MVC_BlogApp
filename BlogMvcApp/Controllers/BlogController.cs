...
namespace BlogMvcApp.Controllers
{
    public class BlogController : Controller
    {
        ...
        //list methodu olusturduk

  

        public ActionResult List(int? id, string q ) //id siz de calisir
        {
            var bloglar = db.Bloglar.Where(i => i.Onay == true).Select(
    i => new BlogModel()
    {
        Id = i.Id,
    ...
    ).AsQueryable();//degerleri eklmeye yarar

           

            if (id != null)
            {
                bloglar = bloglar.Where(i => i.CategoryId == id); //kategoriye gore sorguladik
            }
            if(q!=null && q != "") //string bos deger olabilir
            {
        ...
        public ActionResult Create()
        {
            ...
            return View(); //bos bir view gondermek
        }
        ...
        public ActionResult Create([Bind(Include = "Baslik,Aciklama,Resim,Icerik,CategoryId")] Blog blog)
        {
            if (ModelState.IsValid)
            {
                ...
                //bool deger varsayalin degerleri falsedur burda tekrar false yapmadik
                db.Bloglar.Add(blog);
                db.SaveChanges();
        ...
        {
            if (ModelState.IsValid) // validation islelmer onaylanirsa veriyi guncelleme kisimina gecilir
            {
